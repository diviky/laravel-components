...
class Timezone
{
    ...
    protected static array $regions = [
        TimeZoneRegionEnum::Africa => DateTimeZone::AFRICA,
        TimeZoneRegionEnum::America => DateTimeZone::AMERICA,
        TimeZoneRegionEnum::Antarctica => DateTimeZone::ANTARCTICA,
        TimeZoneRegionEnum::Arctic => DateTimeZone::ARCTIC,
        TimeZoneRegionEnum::Asia => DateTimeZone::ASIA,
        TimeZoneRegionEnum::Atlantic => DateTimeZone::ATLANTIC,
        TimeZoneRegionEnum::Australia => DateTimeZone::AUSTRALIA,
        TimeZoneRegionEnum::Europe => DateTimeZone::EUROPE,
        TimeZoneRegionEnum::Indian => DateTimeZone::INDIAN,
        TimeZoneRegionEnum::Pacific => DateTimeZone::PACIFIC,
    ];
    ...
    public function all(): array
    {
        ...
        if ($this->shouldIncludeRegion(TimeZoneRegionEnum::General)) {
            $timezones[TimeZoneRegionEnum::General] = self::$generalTimezones;
        }
    ...
    public function allMapped(): array
    {
        ...
        if ($this->shouldIncludeRegion(TimeZoneRegionEnum::General)) {
            $timezones[] = [
                'id' => TimeZoneRegionEnum::General,
                'name' => TimeZoneRegionEnum::General,
