...
class Timezone
{
     ...
     */
    protected static array $mappedCache = [];
    ...
    public static function mapped(array|string|bool|null $only = null): array
    {
        $only ??= false;
        ...
        return self::$mappedCache[$cacheKey];
    }
     ...
     */
    protected function normalizeOffset(string $timezone, string $offset): bool|string
    {
